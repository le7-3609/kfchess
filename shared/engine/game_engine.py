...
from shared.rules.rule_engine import (
...
from shared.engine.play_state import (
    GamePlayState,
    ActivePlayState,
    GameOverPlayState,
    GamePlayStateFactory,
)
from shared.engine.click_commands import ClickCommandProcessor
...
class GameEngine:
    ...
    def _create_default_arbiter(self) -> RealTimeArbiterInterface:
        ...
        from shared.rules.piece_rules import StandardPawnPromotion
