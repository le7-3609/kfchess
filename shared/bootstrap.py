...
This is the composition root for the shared core engine package.
"""
...
from shared.events import EventBus, GameStartedEvent, PieceCapturedEvent, PieceMovedEvent
from shared.rules.rule_engine import PathChecker
from shared.realtime.real_time_arbiter import RealTimeArbiter, ChebyshevDistanceDuration, InstantMovementDuration
from shared.engine.game_engine import (
    GameEngine,
...
from shared.repos import _InMemoryBoardRepo, _InMemoryStateRepo
