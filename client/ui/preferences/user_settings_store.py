...
_DEFAULT_PATH = os.path.join(
    os.path.dirname(__file__), "..", "..", "..", ui_consts.USER_SETTINGS_FILE_NAME
)
...
class UserSettings:
    ...
    speed_level_ms: int = ui_consts.DEFAULT_SPEED_LEVEL_MS
    cooldown_level_ms: int = ui_consts.DEFAULT_COOLDOWN_LEVEL_MS
...
class UserSettingsStore:
    ...
    def load(self) -> UserSettings:
        ...
        return UserSettings(
            piece_theme=data.get(ui_consts.SETTINGS_KEY_PIECE_THEME, DEFAULT_THEME_ID),
            board_theme=data.get(ui_consts.SETTINGS_KEY_BOARD_THEME, DEFAULT_BOARD_THEME_ID),
            speed_level_ms=data.get(
                ui_consts.SETTINGS_KEY_SPEED_LEVEL_MS, ui_consts.DEFAULT_SPEED_LEVEL_MS
            ),
            cooldown_level_ms=data.get(
                ui_consts.SETTINGS_KEY_COOLDOWN_LEVEL_MS, ui_consts.DEFAULT_COOLDOWN_LEVEL_MS
            ),
        )

    def save(self, settings: UserSettings) -> None:
        payload = {
            ui_consts.SETTINGS_KEY_PIECE_THEME: settings.piece_theme,
            ui_consts.SETTINGS_KEY_BOARD_THEME: settings.board_theme,
            ui_consts.SETTINGS_KEY_SPEED_LEVEL_MS: settings.speed_level_ms,
            ui_consts.SETTINGS_KEY_COOLDOWN_LEVEL_MS: settings.cooldown_level_ms,
        }
