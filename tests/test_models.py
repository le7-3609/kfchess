import unittest
from kfchess.models import Color, PieceType, Piece, Position, Board
...
class TestPiece(unittest.TestCase):
    def test_piece_creation_and_string(self):
        p1 = Piece(Color.WHITE, PieceType.KING)
        self.assertEqual(str(p1), "wK")
        p2 = Piece(Color.BLACK, PieceType.PAWN)
        self.assertEqual(str(p2), "bP")
...
class TestBoard(unittest.TestCase):
    def test_board_size_and_empty(self):
        board = Board(3, 4)
