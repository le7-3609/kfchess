...
This is the composition root for the core engine package.
"""
...
from core.events import EventBus, GameStartedEvent, PieceCapturedEvent, PieceMovedEvent
from core.rules.rule_engine import PathChecker
from core.realtime.real_time_arbiter import RealTimeArbiter, ChebyshevDistanceDuration, InstantMovementDuration
from core.engine.game_engine import (
    GameEngine,
...
from core.repos import _InMemoryBoardRepo, _InMemoryStateRepo
