...
from core.rules.piece_rules import MoveValidatorFactoryInterface
...
from core.events import EventBus, GameEndedEvent
from core.realtime.arbiter_interfaces import RealTimeArbiterInterface
from core.engine.engine_interfaces import (
    BoardRepositoryInterface,
    GameStateRepositoryInterface,
    BoardPrinterInterface,
)
from core.engine.play_state import (
    GamePlayState,
    ActivePlayState,
    GameOverPlayState,
    GamePlayStateFactory,
)
from core.engine.click_commands import ClickCommandProcessor
from core.engine.jump_commands import JumpCommandProcessor
from core.engine.castling_commands import CastlingCommands
...
class GameEngine:
    ...
    def _create_default_arbiter(self) -> RealTimeArbiterInterface:
        ...
        from core.rules.piece_rules import StandardPawnPromotion
